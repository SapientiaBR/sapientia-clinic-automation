...
const FloatingWhatsApp = () => {
  ...
  useEffect(() => {
    ...
    const tween = gsap.timeline({ repeat: -1, repeatDelay: 28 })
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 w-11 h-11 rounded-full flex items-center justify-center"
      style={{ background: "#25D366", boxShadow: "0 10px 24px rgba(70,55,35,0.20)" }}
    >
