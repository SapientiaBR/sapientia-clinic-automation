...
const FloatingWhatsApp = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center"
      style={{ background: "#25D366", boxShadow: "0 14px 32px rgba(70,55,35,0.22)" }}
    >
