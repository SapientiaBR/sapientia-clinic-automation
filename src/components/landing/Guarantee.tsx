...
const Guarantee = () => {
  ...
  return (
    <section id="garantia" className="section-padding relative" ref={ref}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl relative z-10">
        <div
          ...
          style={{
            ...
            boxShadow: "0 24px 60px rgba(15,181,163,0.10)",
          }}
          data-reveal
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(15,181,163,0.18), transparent 70%)",
            }}
          />
